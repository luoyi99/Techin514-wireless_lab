...
void dataAggregation(int data){
  // Update maximum and minimum distance
...
static void notifyCallback(
  ...
  bool isNotify) {
    ...
    for (size_t i = 0; i < length; i++) {
      received_data = received_data * 256 + pData[i];
    }
    dataAggregation(received_data);

    // TODO: change the following code to customize your own data format for printing
    // Print received, maximum, and minimum data
